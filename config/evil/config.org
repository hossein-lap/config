...
#+BEGIN_SRC emacs-lisp
  (use-package emacs
    ...
    :config
    (setq frame-title-format '("Emacs Evil") ; Yayyyyy Evil!
...
#+RESULTS:
| electric-pair-mode | hl-todo-mode | display-line-numbers-mode | highlight-numbers-mode | vi-tilde-fringe-mode |
...
#+RESULTS:
| /home/hos/.config/emacs/.local/cache/themes/ | /home/hos/.config/emacs/.local/straight/build-29.1/doom-themes/ | custom-theme-directory | ~/.config/emacs/.local/straight/build-29.1/doom-themes/ | t |
...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (setq
          ...
          dashboard-startup-banner "EMACS"
          dashboard-banner-logo-title "Evil"
          dashboard-items nil
...
*** Flycheck
A modern
on-the-fly syntax checking extension -- absolute essential
#+BEGIN_SRC emacs-lisp
...
** Custom fonts
#+begin_src emacs-lisp
  (defvar hosfamily "Fira Sans") ;; sans face
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-bullets-bullet-list '("⦿" "◉" "✸" "✿" "◆"))
    (custom-set-faces
      `(org-document-title ((t (:inherit outline-1 :weight bold :height 2.0 :family ,hosfamily))))
      `(org-level-1        ((t (:inherit outline-1 :weight bold :height 2.0 :family ,hosfamily))))
      `(org-level-2        ((t (:inherit outline-2 :weight bold :height 1.75 :family ,hosfamily))))
      `(org-level-3        ((t (:inherit outline-3 :weight bold :height 1.5 :family ,hosfamily))))
      `(org-level-4        ((t (:inherit outline-4 :weight bold :height 1.25 :family ,hosfamily))))
