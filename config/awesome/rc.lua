...
-- aliases
local focus_bg ="#005577"
local focus_fg  = "#dddddd"
local norm_bg  = "#232323"
...
--			  {description = "run prompt", group = "launcher"}),
	...
	-- srun
	awful.key({ modkey, "Shift" },			"r",	 function () awful.util.spawn("bash -c '".. scripts .."dm-srun.sh'") end,
			  {description = "hossein-lap/scripts run prompt", group = "launcher"}),
...
--  -- Custom keybindings
	...
	-- dm-shot.sh
	awful.key({ },   "Print", function () awful.util.spawn("bash -c '".. scripts .."dm-shot.sh'") end,
			  {description = "dm-shot.sh", group = "launcher"}),

	---- dm-exit.sh
	--awful.key({ modkey },   "q",	 function () awful.util.spawn("bash /home/hos/bin/dm-exit.sh") end,
			  --{description = "dm-exit.sh", group = "launcher"}),
	...
	-- qutebrowser
	awful.key({ modkey, "Shift" },   "w",	 function () awful.util.spawn("qutebrowser") end,
...
--awful.spawn.with_shell("xwallpaper --zoom ~/Pictures/arcolinux/koi-fishes-1920x1080.png")
-- awful.spawn.with_shell("xwallpaper --zoom ~/Pictures/minimalist/image_2021-02-16_16-59-50.png")
-- awful.spawn.with_shell("setxkbmap -layout us,ir -option 'grp:alt_caps_toggle'")
awful.spawn.with_shell("bash ~/.config/awesome/autostart.sh")
-- awful.spawn.with_shell("xcompmgr")
-- awful.spawn.with_shell("pulseaudio")
-- }}}
--awful.spawn.with_shell("xwallpaper --zoom ~/Pictures/minimalist/image_2021-02-16_16-59-50.png")
--awful.spawn.with_shell("xwallpaper --zoom /home/hos/Pictures/Resplash/vApSOxz4pXg_Full.jpg")
